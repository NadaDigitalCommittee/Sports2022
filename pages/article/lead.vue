  ...
  <div class="bg">
    ...
    <div class="speech">
      <div class="concept">
        ...
        <p class="aisatu">引率課長の藤澤です。引率課は競技に出場する生徒をスムーズに最短距離で引率する方法を考え、その資料を作成しています。一見その重要性は伝わらないかもしれませんが、引率の方法を間違えると競技の進行が大幅に遅れ見栄えも悪くなってしまいます。競技のスムーズな進行は体育委員の美しい引率によって成り立っていることを忘れないで頂けると幸いです。以上引率課の紹介でした。<br/><br/>体育祭は雨天や新型コロナウイルスの影響で３年連続短縮開催を余儀なくされ、これまで続いてきた伝統も存続の危機に立たされています。通常開催を経験したことがある最後の学年である僕達76回生が体育委員会に所属するのも今年が最後となります。体育委員会は76回生を中心としてその責任、重圧、期待を背負いながら常に前を向き、新たな形の体育祭を模索し続けてきました。この体育祭が、かつての体育祭を取り戻す、いやそれをはるかに上回る新時代の幕開けとなることを願っています。</p>
    </div>
    </div>
  </div>
</template>
