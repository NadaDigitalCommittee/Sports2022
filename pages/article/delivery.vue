  ...
  <div class="bg">
    ...
    <div class="speech">
      <div class="concept">
        ...
        <div class="profile">
          <img src="~/assets/img/no_image_square.jpg" alt="運搬課長の顔写真" class="face">
          <div class="names">
            <p class="role">運搬課長</p>
            <div class="pl"/>
            <p class="name">T.Y</p>
